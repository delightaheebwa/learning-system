...
| 08 | Optimization — Gradient Descent Family | ~75 min | 7 | Python (Julia optional) | in-progress (paused 2/5) | Resume from CP3 (Adam) after re-sealing zigzag vs overshoot. 2026-09-07 | Source: Phase 1 L08 `docs/en.md` + Further Reading. Lang per lesson header (Python (Julia optional)). |
