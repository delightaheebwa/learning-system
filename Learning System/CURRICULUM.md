...
- **Phase note:** L01–L06 covered by Mission 0 catch-up; L07 done 2026-09-05; L08 Optimization done 2026-09-10 (retrieval + Feynman pass); L09 Information Theory in-progress — paused mid-Checkpoint 5/6 (2026-09-16): CP1–CP3 banked, CP4 re-sealed (the 09-16 warm-up went 4/4 under fresh numbers), CP5 idea + four-form breakdown + the KL-connection walkthrough delivered; resume inside CP5 at the nonnegativity re-digest and the E1 KL-form repair, then CP5 practice on a fresh joint, then V(X,Y) consolidation and CP6.
...
| 09 | Information Theory — Entropy, KL Divergence | ~45 min | 8 | Python (Julia optional) | in-progress | Paused mid-Checkpoint 5/6 (2026-09-16): CP1 surprise + CP2 entropy + CP3 cross-entropy + CP4 KL banked (CP4 re-sealed — the 09-16 warm-up went 4/4 under fresh numbers); CP5 mutual information — idea + four-form breakdown + KL-connection walkthrough delivered (0.531 bits on the running joint), while CP5 practice (fresh joint) + Feynman and two repairs (nonnegativity re-digest, E1 KL-form slip) remain pending. Resume inside CP5 (not at the idea). Source: Phase 1 L09 `docs/en.md` + Further Reading. Lang per lesson header (Python (Julia optional)). |
