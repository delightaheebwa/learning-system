...
- **Phase note:** L01–L06 covered by Mission 0 catch-up; L07 done 2026-09-05; L08 Optimization done 2026-09-10 (retrieval + Feynman pass); L09 Information Theory in-progress — paused mid-Checkpoint 5/6 (2026-09-15): CP1–CP3 banked, CP4 re-sealed after a resume-warm-up regression, CP5 idea + four-form breakdown delivered; resume inside CP5 at the KL-connection walkthrough, then CP5 practice.
...
| 09 | Information Theory — Entropy, KL Divergence | ~45 min | 8 | Python (Julia optional) | in-progress | Paused mid-Checkpoint 5/6 (2026-09-15): CP1 surprise + CP2 entropy + CP3 cross-entropy + CP4 KL banked (CP4 re-sealed 09-15 after a resume warm-up regression); CP5 mutual information — idea + four-form breakdown delivered, KL-connection walkthrough + CP5 practice + Feynman pending. Resume inside CP5 (not at the idea). Source: Phase 1 L09 `docs/en.md` + Further Reading. Lang per lesson header (Python (Julia optional)). |
