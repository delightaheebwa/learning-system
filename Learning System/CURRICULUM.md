...
## Mission 2 — Phase 1: Math Foundations *(~23 hours · Python (Julia optional) · in-progress)*

Goal: Math Foundations — see upstream `phases/01-*/docs/en.md` per lesson. Goal phrasing follows Rohit ROADMAP.md phase header.

- **Phase note:** L01–L06 covered by Mission 0 catch-up; L07 done 2026-09-05; L08 Optimization done 2026-09-10 (retrieval + Feynman pass); L09 Information Theory in-progress — paused mid-Checkpoint 5/6 (2026-09-18): CP1–CP3 banked, CP4 re-sealed (the 09-16 warm-up went 4/4 under fresh numbers), CP5 idea + four-form breakdown + the KL-connection walkthrough + the nonnegativity re-digest (rebate/cost reading, Gibbs' inequality, the one-line Jensen proof with the deliberate numerator reversal, the Jensen-vs-Gibbs division of labour) delivered and exit-ticketed 3/3; resume inside CP5 at (1) CP5 practice on a fresh joint, (2) V(X,Y) consolidation, (3) CP6, (4) Feynman + final cumulative quiz — the E1 KL-form slip recurred 2026-09-18 and is still unbanked.
...
| 09 | Information Theory — Entropy, KL Divergence | ~45 min | 8 | Python (Julia optional) | in-progress | Paused mid-Checkpoint 5/6 (2026-09-18): CP1 surprise + CP2 entropy + CP3 cross-entropy + CP4 KL banked (CP4 re-sealed — the 09-16 warm-up went 4/4 under fresh numbers); CP5 mutual information — idea + four-form breakdown + KL-connection walkthrough (0.531 bits on the running joint) + the nonnegativity re-digest (rebate/cost reading of the per-term signs, Gibbs' inequality Σ Q·log₂(Q/P) ≥ 0, the one-line Jensen proof with the deliberate numerator reversal, the Jensen-vs-Gibbs division of labour) all delivered and exit-ticketed 3/3. Still pending: CP5 practice (fresh joint) + Feynman; the E1 KL-form slip recurred 2026-09-18. Resume chain: (1) CP5 practice on a fresh joint, (2) V(X,Y) consolidation, (3) CP6 (perplexity + bits/nats + label smoothing), (4) Feynman + final cumulative quiz. Source: Phase 1 L09 `docs/en.md` + Further Reading. Lang per lesson header (Python (Julia optional)). |
...
**Exit:** calculus → probability chain solid; you can implement PMF/PDF, softmax+ NLL, and state CLT without notes. Continue Phase 1 at L09 (Information Theory, in progress).
