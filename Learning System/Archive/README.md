# Archive — consolidated legacy store (refactor 2026-09-08)

> **Rule for models: do NOT grep or bulk-read this tree.** It is reference-only history.
> The Tutor's compact learner context lives in `Learning System/Core/Learner History.md`
> (per-concept fuzzy/neutral/solid tags + pointers). Search here only on an explicit
> revive request, then cite the exact file.
...
- Pre-existing: `CURRICULUM — …archived…md` roadmaps, `MISSION — …archived…md`, `📚 Knowledge Base (Legacy — Split 2026-06-03).md`, `Audit — …`, `Backlog Amnesty — …`.

Convention: new archive drops go in `Archive/<era>-<date>/` with a one-line note appended here. Never scatter legacy files outside this tree.
