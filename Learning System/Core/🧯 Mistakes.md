...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 2026-09-05 | 4-Layer AI Environment Stack | torch imports but CUDA/GPU not visible — which stack layer? | Runtimes (CUDA/runtime layer), not System | structural | Placed GPU-invisible at System layer; missed the Runtimes split (learner wording not supplied — inferred from answer) | active | 0 | 2026-09-15 |
