...
| Base Rate Fallacy | aiefs | concept | developing | Phase 1 L07 notes | 2026-09-19 | 2026-09-22 | definitional | 09-19 review FAIL: ignored half named, conditional-flip half missing (P(+|D) vs P(D|+)). |
...
| MLE vs MAP Estimation | aiefs | concept | developing | Rohit P1 L07 + lesson 2026-09-05 (Python) | 2026-09-19 | 2026-09-22 | discriminative | MAP = MLE × prior; Gaussian prior = L2, Laplace prior = L1. 09-19 review FAIL: mapping named but both rationales wrong (log-prior shape IS the penalty: Gaussian->squares, Laplace->absolute values). |
| Conjugate Priors | aiefs | concept | developing | Rohit P1 L07 + Think Bayes (Python) | 2026-09-19 | 2026-09-22 | definitional | Beta(a,b) + s/f → Beta(a+s,b+f). Update = addition. 09-19 review FAIL: rule given as adding yesterday's posterior to today's prior (sequential-mantra leak) — correct: add observed counts to prior params, Beta(a+s,b+f). |
...
| Learning-rate Schedules (four types) | aiefs | concept | developing | Rohit P1 L08 + Ruder + handwritten notes 2026-09-10 (Python) | 2026-09-19 | 2026-09-22 | definitional | Read η-vs-t curves: early phase (only warmup ramps up) + end behavior (only cosine has nonzero floor η_min; exponential→0 no floor; step=staircase). 0.999 halves η every ~700 steps. 09-17 review FAIL: mapping 3/3 under fresh paraphrase, floor number missed ('very small positive', expected 0.05). 09-19 review FAIL: cosine given a ramp-up (ramps up and decays, stops at a floor) — early-phase discriminator re-inverted (only warmup ramps); step/exponential/warmup halves correct. |
