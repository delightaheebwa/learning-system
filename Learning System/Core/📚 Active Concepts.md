...
- **AIEFS (AI Engineering from Scratch):** Mission 0 catch-up done; P1 L07 done; P1 L08 Optimization **done** (2026-09-10); P1 L09 Information Theory paused at Checkpoint 4/6 (09-14; CP4 done graded pass — resume CP5 mutual information) — **29 live concepts** (all `developing`; counted from the `aiefs` rows of the table below on 2026-09-14: Mission 0 Catch-Up section 6 · Bayes & Statistical Thinking section 20 — of which 12 are L07 Bayes and 8 are L08 Optimization — · Information Theory section 3; total 6 + 20 + 3 = 29. Supersedes the stale "28 live concepts" figure.)
...
| PMF vs PDF | aiefs | concept | developing | Rohit P1 L06 + CS229 (Python) | 2026-09-14 | 2026-09-22 | definitional | PMF=discrete probability, PDF=density (integrate), CDF=cumulative. |
...
| Cosine Similarity | aiefs | concept | developing | Rohit P1 L02 + 3B1B (Python) | 2026-09-14 | 2026-10-15 | discriminative | Unit vectors u·v=cos(θ). Measures alignment −1 to +1. |
...
| Cross-Entropy from NLL | aiefs | concept | developing | Rohit P1 L06 + P1 L09 + Olah + PyTorch CrossEntropyLoss (Python) | 2026-09-14 | 2026-09-21 | discriminative | H(P,Q)=Σ q(x)(−log₂ p(x)): weights from truth Q, surprises from model P (Olah convention here; Rohit/ML flips letters, P=truth → ≥H(P)). = CE loss = NLL (−log ŷ_correct under one-hot). Floor = the data's entropy H(Q): coin Q=(0.75,0.25) vs fair P → H(P,Q)=1.0 bit, floor 0.811, KL 0.189. Floor ≠ model's H(P). REGRESSED 09-14 (warm-up W4): picked reversed inequality H(P,Q) ≤ H(Q) — direction re-inverted; re-seal due 09-17. CP4 (KL) practice pass 09-14; Next Review realigned to Attempts.json (09-21). |
...
| MLE vs MAP Estimation | aiefs | concept | developing | Rohit P1 L07 + lesson 2026-09-05 (Python) | 2026-09-14 | 2026-09-18 | definitional | MAP = MLE × prior; Gaussian prior = L2, Laplace prior = L1. |
...
| Learning Rate | aiefs | concept | developing | Rohit P1 L08 + handwritten notes 2026-09-08 (Python) | 2026-09-14 | 2026-09-22 | discriminative | Step size η. No formula — tune empirically. Too big → overshoot/bounce; too small → freezes. Adam 0.001, SGD+M 0.01. lr and optimizer choice are coupled. |
| Momentum (SGD with Momentum) | aiefs | procedure | developing | Rohit P1 L08 + Goh Distill + handwritten notes 2026-09-08 (Python) | 2026-09-08 | 2026-09-15 | definitional | v = βv + g (β=0.9). Selective accumulator: keeps consistent, cancels zigzag. Direction-dependent step size via eigenvalue λ: big steps along valley (small λ), small steps across walls (large λ). Won this lesson's Rosenbrock race (2941 steps; run-specific ordering — Rohit's defaults expect Adam fastest). |
...
| Mini-batch Noise (two effects) | aiefs | concept | developing | Rohit P1 L08 + handwritten notes 2026-09-10 (Python) | 2026-09-14 | 2026-10-15 | discriminative | Optimization: noisy grad almost never zero → escapes saddles. Generalization: avoids sharp minima → flat basins → better test accuracy. "escape"→saddles; "settle into"→sharp. |
...
| KL Divergence | aiefs | concept | developing | Rohit P1 L09 + Olah (Python) | 2026-09-14 | 2026-09-21 | discriminative | KL(Q∥P)=Σ q·log₂(q/p)=H(P,Q)−H(Q)=CE−H(data). Weights ← truth Q, scores ← model P (Olah letters here; Rohit/ML flips → D_KL(P∥Q)=H(P,Q)−H(P)). ≥0, =0 iff P=Q; NOT symmetric (coin Q=(0.75,0.25) vs fair P: 0.189 vs 0.208 bits); minimizing CE ≡ minimizing KL (H(data) constant in θ); ∞ when the model zeroes a data event → smoothing (add-1/Laplace; label smoothing CP6). |
